...
export type RodEditorProps = { imageData: string; layerOrder: string[]; polygon: [Point, Point, Point, Point]; hook?: Product; wand?: Product; cord?: Product; rod?: Product; curtain?: Product; bracket?: Product; finial?: Product; selectedProductId?: string | null; onSelectProduct?: (productId: string) => void; onDeleteHook: () => void; onDeleteWand: () => void; onDeleteCord: () => void; onDeleteRod: () => void; onDeleteCurtain: () => void; onDeleteBracket: () => void; onDeleteFinial: () => void };
